...
const Search = ({animes}: {
    ...
    return (
        <div className={"inline-block mt-[clamp(3rem, 2vw, 5rem)] p-[3vw]"}>
                    ...
                    <button
                        ...
                        <div
                            ...
                            <div className={"text-center mb-[1rem]"}>
                                ...
                                <p className={"inline-block mt-[0.5rem] md:mt-[1rem] text-[0.7rem] sm:text-[0.8rem] md:text-[1rem] lg:text-[1.1rem] xl:text-[1.3rem] 2xl:text-[1.5rem] text-[#46D369]"}>{anime.rating || 'NaN'}%
                                    liked</p>
                                {" | "}
                                ...
                                {" | "}
                                <p className={"inline-block mt-[0.5rem] md:mt-[1rem] text-[0.7rem] sm:text-[0.8rem] md:text-[1rem] lg:text-[1.1rem] xl:text-[1.3rem] 2xl:text-[1.5rem]"}>{anime.episodes?.length || anime.episodes || anime.totalEpisodes} ep</p>
                            </div>
                        </div>
                    </button>
                </div>
...
export const getServerSideProps: GetServerSideProps = async ({query, res}) => {
    ...
    const [animes]: any = await Promise.all([AniList.getSearch(query.q as string) || null]);
